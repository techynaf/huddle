                    ...
                    <div class="card mt-5">
                        ...
                        <div class="card-body">
                            <form method="POST" action="/branch/create">
                                ...
                                <div class="form-group row my-4">
                                    <label for="name" class="col-sm-4 col-form-label text-md-right pin">Color Code</label>
        
                                    <div class="col-md-6">
                                        <input id="name" type="text" class="form-control" name="color" placeholder="Please enter hex color code the branch" required autofocus>
                                    </div>
                                </div>
