...
<input type="time"  class="form-control" name="start[]" value="{{$schedule->start}}" min="1" max="12" placeholder="HH:MM AM/PM" required>
...
<input type="time" class="form-control" name="end[]" value="{{$schedule->end}}" min="1" max="12" placeholder="HH:MM AM/PM" required>
