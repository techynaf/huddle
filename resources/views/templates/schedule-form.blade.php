...
<input type="time" class="form-control timepicker3" name="start[]" value="{{$schedule->start}}" required>
...
<input type="time" class="form-control timepicker3" name="end[]" value="{{$schedule->end}}" required>
