...
<input type="time" class="form-control" name="start[]" placeholder="HH:MM AM/PM" required>
...
<input type="time" class="form-control" name="end[]" placeholder="HH:MM AM/PM" required>
